...
pl_food_econ_basket_bill_world = ggplot(data = pld_food_econ_basket_bill_regional %>%
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        title = element_text(size = 40)) +
  guides(fill = guide_legend(ncol = 2), color = guide_legend(ncol = 2))
ggsave(pl_food_econ_basket_bill_world, file = paste0(figures_path,"tmp_figs/",'pl2_food_econ_basket_bill_world.pdf'),
       width = 550, height = 500, units = 'mm', limitsize = FALSE)
...
pl_food_econ_basket_bill_regional = ggplot(data = pld_food_econ_basket_bill_regional %>%
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        title = element_text(size = 40)) +
  guides(fill = guide_legend(ncol = 2), color = guide_legend(ncol = 2))
ggsave(pl_food_econ_basket_bill_regional, file = paste0(figures_path,"tmp_figs/",'pl2_food_econ_basket_bill_regional_fixedScales.pdf'),
       width = 1000, height = 1000, units = 'mm', limitsize = FALSE)
...
pl_food_econ_basket_bill_diffPer_regional = ggplot(data = pld_food_econ_basket_bill_diffPer_regional) +
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        title = element_text(size = 40)) +
  guides(fill = guide_legend(ncol = 2), color = guide_legend(ncol = 2))
ggsave(pl_food_econ_basket_bill_diffPer_regional, file = paste0(figures_path,"tmp_figs/",'pl2_food_econ_basket_bill_diffPer_regional.pdf'),
...
pl_ag_beef_production_world = ggplot(data = ag_meet_dairy_production_world %>% filter(sector == 'Beef') %>%
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'vertical',
        ...
        title = element_text(size = 40)) +
  guides(fill = guide_legend(ncol = 2), color = guide_legend(ncol = 2))
ggsave(pl_ag_beef_production_world, file = paste0(figures_path,"tmp_figs/",'pl3_ag_beef_production_world.pdf'),
       width = 550, height = 500, units = 'mm', limitsize = FALSE)
...
pl_ag_beef_production_diffPer_world = ggplot(data = ag_beef_production_diffPer_world) +
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        legend.title = element_text(size = 40),
        title = element_text(size = 40))
ggsave(pl_ag_beef_production_diffPer_world, file = paste0(figures_path,"tmp_figs/",'pl3_ag_beef_production_diffPer_world.pdf'),
       width = 550, height = 500, units = 'mm', limitsize = FALSE)
...
pl_ag_beef_production_diffPer_regional = ggplot(data = ag_beef_production_diffPer_regional) +
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        legend.title = element_text(size = 40),
        title = element_text(size = 40))
ggsave(pl_ag_beef_production_diffPer_regional, file = paste0(figures_path,"tmp_figs/",'pl3_ag_beef_production_diffPer_regional_fixedScales.pdf'),
...
pl_ag_beef_production_diffPer_regional = ggplot(data = ag_beef_production_diffPer_regional) +
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        legend.title = element_text(size = 40),
        title = element_text(size = 40))
ggsave(pl_ag_beef_production_diffPer_regional, file = paste0(figures_path,"tmp_figs/",'pl3_ag_beef_production_diffPer_regional_freeScales.pdf'),
       width = 750, height = 750, units = 'mm', limitsize = FALSE)
...
micronutrients_data = readr::read_csv(paste0(folder_analysis_path,"data/micronutrients_data.csv")) %>%
  select(-1)
...
plt_kcal_intake = ggplot(des_der %>%
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        legend.title = element_text(size = 40),
        title = element_text(size = 40))
ggsave(plt_kcal_intake, file = paste0(figures_path,"tmp_figs/",'pl4_kcal_intake_regional_freeScales.pdf'),
       width = 1000, height = 1000, units = 'mm')
...
plt_kcal_intake = ggplot(des_der %>%
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'bottom', legend.direction = 'horizontal',
        ...
        legend.title = element_text(size = 40),
        title = element_text(size = 40))
ggsave(plt_kcal_intake, file = paste0(figures_path,"tmp_figs/",'pl4_kcal_intake_regional_fixedScales.pdf'),
       width = 1000, height = 1000, units = 'mm')
