...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["L0_Supplysector_relative-cost-logit"]] <- c("region", "supplysector")
  level2_data_names[["L0_DeleteSupplysector"]] <- c("region", "supplysector")

  level2_data_names[["L1_Subsector"]] <- c("region", "supplysector", "subsector_nest1")
  level2_data_names[["L1_SubsectorAll"]] <- c(level2_data_names[["L1_Subsector"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L1_SubsectorAllTo"]] <- c(level2_data_names[["L1_Subsector"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "to.value", "interpolation.function")
  level2_data_names[["L1_SubsectorLogit"]] <- c(level2_data_names[["L1_Subsector"]], "logit.year.fillout", "logit.exponent")
  level2_data_names[["L1_SubsectorLogit_absolute-cost-logit"]] <- c("region", "supplysector", "subsector_nest1")
  level2_data_names[["L1_SubsectorLogit_relative-cost-logit"]] <- c("region", "supplysector", "subsector_nest1")
  level2_data_names[["L1_SubsectorShrwt"]] <- c(level2_data_names[["L1_Subsector"]], "year", "share.weight")
  level2_data_names[["L1_SubsectorShrwtFllt"]] <- c(level2_data_names[["L1_Subsector"]], "year.fillout", "share.weight")
  level2_data_names[["L1_SubsectorInterp"]] <- c(level2_data_names[["L1_Subsector"]], "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L1_SubsectorInterpTo"]] <- c(level2_data_names[["L1_Subsector"]], "apply.to", "from.year", "to.year", "to.value", "interpolation.function")
  level2_data_names[["L1_FuelPrefElast"]] <- c(level2_data_names[["L1_Subsector"]], "year.fillout", "fuelprefElasticity")
  level2_data_names[["L1_DeleteSubsector"]] <- level2_data_names[["L1_Subsector"]]

  level2_data_names[["L2_Subsector"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2")
  level2_data_names[["L2_SubsectorNonFood"]] <- c("region", "supplysector", "subsector")
  level2_data_names[["L2_SubsectorAll"]] <- c(level2_data_names[["L2_Subsector"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L2_SubsectorAllNonFood"]] <- c(level2_data_names[["L2_SubsectorNonFood"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L2_SubsectorAllTo"]] <- c(level2_data_names[["L2_Subsector"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "to.value", "interpolation.function")
  level2_data_names[["L2_SubsectorLogit"]] <- c(level2_data_names[["L2_Subsector"]], "logit.year.fillout", "logit.exponent")
  level2_data_names[["L2_SubsectorLogit_absolute-cost-logit"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2")
  level2_data_names[["L2_SubsectorLogit_relative-cost-logit"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2")
  level2_data_names[["L2_SubsectorLogitNonFood"]] <- c(level2_data_names[["L2_SubsectorNonFood"]], "logit.year.fillout", "logit.exponent")
  level2_data_names[["L2_SubsectorLogitNonFood_absolute-cost-logit"]] <- c("region", "supplysector", "subsector")
  level2_data_names[["L2_SubsectorLogitNonFood_relative-cost-logit"]] <- c("region", "supplysector", "subsector")
  level2_data_names[["L2_SubsectorShrwt"]] <- c(level2_data_names[["L2_Subsector"]], "year", "share.weight")
  level2_data_names[["L2_SubsectorShrwtFllt"]] <- c(level2_data_names[["L2_Subsector"]], "year.fillout", "share.weight")
  level2_data_names[["L2_SubsectorInterp"]] <- c(level2_data_names[["L2_Subsector"]], "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L2_SubsectorInterpNonFood"]] <- c(level2_data_names[["L2_SubsectorNonFood"]], "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L2_SubsectorInterpTo"]] <- c(level2_data_names[["L2_Subsector"]], "apply.to", "from.year", "to.year", "to.value", "interpolation.function")
  level2_data_names[["L2_FuelPrefElast"]] <- c(level2_data_names[["L2_Subsector"]], "year.fillout", "fuelprefElasticity")
  level2_data_names[["L2_DeleteSubsector"]] <- level2_data_names[["L2_Subsector"]]

  level2_data_names[["L3_Subsector"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2", "subsector")
  level2_data_names[["L3_SubsectorNonFood"]] <- c("region", "supplysector", "subsector")
  level2_data_names[["L3_SubsectorAll"]] <- c(level2_data_names[["L3_Subsector"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L3_SubsectorAllNonFood"]] <- c(level2_data_names[["L3_SubsectorNonFood"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L3_SubsectorAllTo"]] <- c(level2_data_names[["L3_Subsector"]], "logit.year.fillout", "logit.exponent", "year.fillout", "share.weight", "apply.to", "from.year", "to.year", "to.value", "interpolation.function")
  level2_data_names[["L3_SubsectorLogit"]] <- c(level2_data_names[["L3_Subsector"]], "logit.year.fillout", "logit.exponent")
  level2_data_names[["L3_SubsectorLogit_absolute-cost-logit"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2", "subsector")
  level2_data_names[["L3_SubsectorLogit_relative-cost-logit"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2", "subsector")
  level2_data_names[["L3_SubsectorLogitNonFood"]] <- c(level2_data_names[["L3_SubsectorNonFood"]], "logit.year.fillout", "logit.exponent")
  level2_data_names[["L3_SubsectorLogitNonFood_absolute-cost-logit"]] <- c("region", "supplysector", "subsector")
  level2_data_names[["L3_SubsectorLogitNonFood_relative-cost-logit"]] <- c("region", "supplysector", "subsector")
  level2_data_names[["L3_SubsectorShrwt"]] <- c(level2_data_names[["L3_Subsector"]], "year", "share.weight")
  level2_data_names[["L3_SubsectorShrwtFllt"]] <- c(level2_data_names[["L3_Subsector"]], "year.fillout", "share.weight")
  level2_data_names[["L3_SubsectorInterp"]] <- c(level2_data_names[["L3_Subsector"]], "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L3_SubsectorInterpNonFood"]] <- c(level2_data_names[["L3_SubsectorNonFood"]], "apply.to", "from.year", "to.year", "interpolation.function")
  ...
  level2_data_names[["L4_TechInterp"]] <- c(level2_data_names[["L4_Tech"]], "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L4_TechInterpTo"]] <- c(level2_data_names[["L4_Tech"]], "apply.to", "from.year", "to.year", "to.value", "interpolation.function")
  level2_data_names[["L4_TechYr"]] <- c(level2_data_names[["L4_Tech"]], "year")
  level2_data_names[["L4_Production"]] <- c(level2_data_names[["L4_TechYr"]], "calOutputValue", "share.weight.year", "subs.share.weight", "tech.share.weight")
  level2_data_names[["L4_TechShrwt"]] <- c(level2_data_names[["L4_TechYr"]], "share.weight")
  level2_data_names[["L4_StubTech"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2", "subsector", "stub.technology")
  level2_data_names[["L4_StubTechNonFood"]] <- c("region", "supplysector", "subsector", "stub.technology")
  level2_data_names[["L4_StubTechYr"]] <- c(level2_data_names[["L4_StubTech"]], "year")
  level2_data_names[["L4_StubTechYrNonFood"]] <- c(level2_data_names[["L4_StubTechNonFood"]], "year")
  level2_data_names[["L4_StubTechInterp"]] <- c(level2_data_names[["L4_StubTech"]], "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L4_StubTechShrwt"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2", "subsector", "stub.technology", "year", "share.weight")
  level2_data_names[["L4_StubTechCoef"]] <- c(level2_data_names[["L4_StubTechYr"]], "minicam.energy.input", "coefficient", "market.name")
  level2_data_names[["L4_StubTechEff"]] <- c(level2_data_names[["L4_StubTechYr"]], "minicam.energy.input", "efficiency", "market.name")
  level2_data_names[["L4_StubTechProd"]] <- c(level2_data_names[["L4_StubTechYr"]], "calOutputValue", "share.weight.year", "subs.share.weight", "tech.share.weight")
  level2_data_names[["L4_StubTechProdNonFood"]] <- c(level2_data_names[["L4_StubTechYrNonFood"]], "calOutputValue", "share.weight.year", "subs.share.weight", "tech.share.weight")
  level2_data_names[["L4_StubCalorieContent"]] <- c("region", "supplysector", "subsector_nest1", "subsector_nest2", "subsector", "stub.technology", "year", "minicam.energy.input", "efficiency")
  level2_data_names[["L4_StubTechCalorieContent"]] <- c(level2_data_names[["L4_StubTechEff"]])
  level2_data_names[["L4_GlobalTech"]] <- c("sector.name", "subsector.name", "technology")
  level2_data_names[["L4_GlobalTechInterp"]] <- c("sector.name", "subsector.name", "technology", "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["L4_GlobalTechInterpTo"]] <- c("sector.name", "subsector.name", "technology", "apply.to", "from.year", "to.year", "to.value", "interpolation.function")
  level2_data_names[["L4_GlobalTechShrwt"]] <- c("sector.name", "subsector.name", "technology", "year", "share.weight")
  level2_data_names[["L4_GlobalTechYr"]] <- c(level2_data_names[["L4_GlobalTech"]], "year")
  level2_data_names[["L4_GlobalTechCoef"]] <- c(level2_data_names[["L4_GlobalTechYr"]], "minicam.energy.input", "coefficient")
