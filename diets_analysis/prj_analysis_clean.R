...
spp_protein_all_india <- ggplot(data = plot_data %>%
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'right', legend.direction = 'vertical',
        ...
        legend.text = element_text(size = 25),
        legend.title = element_text(size = 30))
ggsave(spp_protein_all_india, file = file.path(figures_path, paste0('spp_protein_all_eu15_',year_fig,'.png')),
...
spp_protein_plus_india <- ggplot(data = plot_data %>%
  ...
  theme(legend.key.size = unit(2, "cm"), legend.position = 'right', legend.direction = 'vertical',
        ...
        legend.text = element_text(size = 25),
        legend.title = element_text(size = 30))
ggsave(spp_protein_plus_india, file = file.path(figures_path, paste0('spp_protein_plus_eu15_',year_fig,'.png')),
       width = 500, height = 350, units = 'mm')
